...
import { BookOpen, Sparkles, Heart, Star, Cloud, ArrowLeft, RefreshCw, CheckCircle, Home } from "lucide-react"

function StoryOutlineContent() {
...
💝 故事主题：勇气、友谊、成长`
  ...
  const handleConfirmOutline = () => {
    if (outline.trim()) {
      // 跳转到完整故事页面
      router.push(`/full-story?outline=${encodeURIComponent(outline)}`)
    }
  }
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            {/* 可爱的图标 */}
            <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 rounded-full mb-6 shadow-lg animate-bounce relative">
            ...
            <div className="relative mb-6">
              <h1 className="text-5xl md:text-7xl font-black tracking-wider text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text transform -rotate-1 relative">
                故事大纲
              ...
              {/* 装饰性背景 */}
              <div className="absolute -inset-4 bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200 rounded-3xl opacity-20 -z-10 transform rotate-1"></div>
              <div className="absolute -inset-6 bg-gradient-to-r from-yellow-200 via-blue-200 to-purple-200 rounded-3xl opacity-15 -z-20 transform -rotate-1"></div>
            </div>
          ...
          {/* 用户输入的主题显示 */}
          {theme && (
            <div className="bg-white rounded-3xl p-6 mb-8 border-4 border-yellow-200 shadow-xl relative overflow-hidden">
              <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-yellow-300 to-orange-300 rounded-bl-full opacity-50"></div>
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-3">
                  <Star className="w-6 h-6 text-yellow-500" />
                  <span className="font-black text-xl text-gray-700">你的故事主题：</span>
                </div>
                <p className="text-lg text-gray-600 font-medium bg-gradient-to-r from-yellow-50 to-orange-50 p-4 rounded-2xl border-2 border-yellow-300">
                  {theme}
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border-4 border-purple-200 relative overflow-hidden mb-8">
            ...
            <div className="relative z-10">
              <label
                ...
                className="flex items-center gap-2 text-left text-xl font-black text-gray-700 mb-6"
              >
              ...
              {isGenerating ? (
                <div className="min-h-[450px] flex items-center justify-center">
                  <div className="text-center">
                    <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full mb-6 animate-spin">
                      <Sparkles className="w-10 h-10 text-white" />
                    </div>
                    <h3 className="text-2xl font-black text-gray-700 mb-2">🎨 AI魔法师正在创作中...</h3>
                    <p className="text-lg text-gray-500 font-medium">请稍等片刻，精彩故事即将呈现！</p>
                ...
                <Textarea
                  ...
                  className="min-h-[450px] text-lg border-2 border-purple-300 focus:border-pink-400 rounded-2xl resize-none font-medium bg-gradient-to-br from-white to-purple-50 placeholder:text-gray-400 placeholder:opacity-60 p-6"
                />
              )}

              <div className="flex justify-between items-center mt-4">
                <div className="text-sm text-gray-500 font-medium">💡 你可以随意修改大纲内容，让故事更符合你的想象</div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
            <Button
              ...
              className="bg-gradient-to-r from-blue-400 to-cyan-400 hover:from-blue-500 hover:to-cyan-500 text-white font-black text-xl px-10 py-5 rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-110 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none border-4 border-white"
            >
          ...
          {/* 提示信息 */}
          <div className="text-center">
            <div className="bg-white rounded-2xl p-6 border-2 border-green-200 shadow-lg inline-block">
              <p className="text-lg text-gray-600 font-bold">💝 确认大纲后，AI将为你创作完整的故事内容和精美插图</p>
            </div>
          </div>
        </div>
      </div>
      ...
      fallback={
        <div className="min-h-screen bg-gradient-to-br from-yellow-100 via-pink-100 to-purple-100 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-xl font-bold text-gray-600">加载中...</p>
          </div>
        </div>
      }
    >
