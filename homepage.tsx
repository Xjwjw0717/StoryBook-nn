    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 via-pink-100 to-purple-100 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-10">
            {/* 可爱的logo */}
            <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-r from-orange-300 via-pink-300 to-purple-300 rounded-full mb-6 shadow-lg animate-bounce">
            ...
            {/* 主标题 - 更可爱的字体 */}
            <h1 className="text-5xl md:text-7xl font-black tracking-wide bg-gradient-to-r from-orange-400 via-pink-500 to-purple-500 bg-clip-text text-transparent mb-2 drop-shadow-sm">
              为你的孩子
            </h1>
            <h1 className="text-5xl md:text-7xl font-black tracking-wide bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent mb-6 drop-shadow-sm">
              创作专属故事绘本
            </h1>
...
🌈 还有：关于友谊和快乐的温暖故事..."
                  ...
                  className="min-h-[140px] text-lg border-3 border-pink-300 focus:border-purple-400 rounded-2xl resize-none font-medium bg-gradient-to-br from-white to-pink-50"
                />
          ...
          <div className="mb-12">
            <Button
              ...
              className="bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 hover:from-pink-500 hover:via-purple-500 hover:to-blue-500 text-white font-black text-2xl px-16 py-6 rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-110 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none border-4 border-white"
            >
              <Sparkles className="w-8 h-8 mr-3 animate-spin" />🎨 开始创作魔法故事 ✨
            </Button>
          </div>
